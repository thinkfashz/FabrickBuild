...
import { Bot, Boxes, ExternalLink, Gauge, Settings2 } from 'lucide-react'
    ...
    <div className="studio-shell">
      <aside className="studio-sidebar">
        ...
        <nav className="studio-nav" aria-label="Navegación del estudio">
          ...
          <Link href="/admin/collections/pages"><Gauge size={18} /><span>Editor de páginas</span></Link>
      ...
      <div className="studio-main">
        <header className="studio-mobile-head">
          ...
          <div className="studio-mobile-links">
            ...
            <Link href="/admin/collections/pages" aria-label="Editor de páginas en Payload"><Gauge size={19} /></Link>
          </div>
        </header>
        {children}
      </div>
