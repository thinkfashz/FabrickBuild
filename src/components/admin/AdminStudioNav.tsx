...
export default function AdminStudioNav() {
  return (
    <section aria-label="Accesos de contenido FabrickBuild" style={{ margin: '4px 8px 14px', padding: 10, display: 'grid', gap: 8, border: '1px solid var(--theme-elevation-100)', borderRadius: 12, background: 'linear-gradient(135deg, color-mix(in srgb, var(--theme-elevation-50) 92%, #f4c84b 8%), var(--theme-elevation-50))' }}>
      <p style={{ margin: '0 8px 2px', color: 'var(--theme-elevation-500)', fontSize: 10, fontWeight: 800, letterSpacing: '.12em', textTransform: 'uppercase' }}>Contenido FabrickBuild</p>

      <NavCard href="/admin/collections/pages" title="Páginas y visor" detail="Editor Payload, bloques, colores y preview responsive" icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 20h16"/><path d="m7 17 10-10 3 3L10 20H7z"/><path d="m14 7 3 3"/></svg>} />
      ...
      <NavCard href="/admin/collections/media" title="Biblioteca multimedia" detail="Blob, Cloudinary, S3, carpetas y registros" icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 7h16v13H4z"/><path d="M8 7V4h8v3"/><path d="m7 16 3-3 2 2 2-2 3 3"/></svg>} />
      <NavCard href="/admin/collections/integrations" title="Integraciones" detail="Proveedores, modelos y bóveda cifrada" icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2v4"/><path d="M12 18v4"/><path d="M2 12h4"/><path d="M18 12h4"/><circle cx="12" cy="12" r="3"/></svg>} />
