...
export const PortfolioShowcase: Block = {
  ...
  labels: { singular: 'Portfolio con movimiento', plural: 'Portfolios con movimiento' },
  fields: [
    ...
    { name: 'description', type: 'textarea', label: 'Descripción', defaultValue: 'Estrategia, identidad y producto digital para marcas que buscan una presencia imposible de ignorar.' },
    {
      name: 'primaryCTA',
      type: 'group',
      label: 'Botón principal',
      fields: [{ name: 'label', type: 'text', defaultValue: 'Ver proyectos' }, { name: 'url', type: 'text', defaultValue: '#proyectos' }],
    },
    {
      name: 'secondaryCTA',
      type: 'group',
      label: 'Botón secundario',
      fields: [{ name: 'label', type: 'text', defaultValue: 'Hablemos' }, { name: 'url', type: 'text', defaultValue: '#contacto' }],
    },
    {
      name: 'techStack',
      type: 'array',
      ...
      defaultValue: [{ label: 'Next.js' }, { label: 'React' }, { label: 'Payload CMS' }, { label: 'GSAP' }, { label: 'Vercel' }],
    },
    {
      name: 'projects',
      type: 'array',
